...
def clone_config_for_openrouter(config: ChackConfig) -> ChackConfig:
    ...
    routed_model = ModelConfig(
        ...
        travel=_strip_prefixed_model(model.travel),
        ...
        researcher_administrator=_strip_prefixed_model(model.researcher_administrator),
        social_network_thinking_effort=model.social_network_thinking_effort,
        scientific_thinking_effort=model.scientific_thinking_effort,
        websearcher_thinking_effort=model.websearcher_thinking_effort,
        business_thinking_effort=model.business_thinking_effort,
        product_thinking_effort=model.product_thinking_effort,
        travel_thinking_effort=model.travel_thinking_effort,
        legal_thinking_effort=model.legal_thinking_effort,
        data_statistics_thinking_effort=model.data_statistics_thinking_effort,
        news_media_thinking_effort=model.news_media_thinking_effort,
        knowledge_graph_thinking_effort=model.knowledge_graph_thinking_effort,
        religious_thinking_effort=model.religious_thinking_effort,
        cli_thinking_effort=model.cli_thinking_effort,
        subchack_thinking_effort=model.subchack_thinking_effort,
        researcher_administrator_thinking_effort=model.researcher_administrator_thinking_effort,
        researcher_queue_thinking_effort=model.researcher_queue_thinking_effort,
        ...
        travel_max_turns=model.travel_max_turns,
        ...
        researcher_administrator_max_turns=model.researcher_administrator_max_turns,
    )
