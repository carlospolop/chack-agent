...
def _build_claude_executor(tmp_path: Path, tools_config_json: str) -> ClaudeCodeExecutor:
    return ClaudeCodeExecutor(
        ...
        _business_max_turns=5,
        _product_max_turns=5,
        _legal_max_turns=5,
        _data_statistics_max_turns=5,
        _news_media_max_turns=5,
        _knowledge_graph_max_turns=5,
        _religious_max_turns=5,
        _cli_max_turns=5,
        _researcher_administrator_max_turns=5,
